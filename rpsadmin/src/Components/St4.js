    ...
    GetData=()=>{
        ...
        .then(()=>{
            ...
            this.setState({
                ...
                projectFindings:(dataForGroup.projectFindings || dataForGroup.projectFindings)?(dataForGroup.projectFindings || dataForGroup.projectFindings):'',
            ...
            <div style={{flex:1}}>
                ...
                <Form style={{marginTop:'4%',marginLeft:'10%',marginRight:'10%'}}>
                    ...
                    <div style={{border:'solid 1px',padding:15,borderRadius:20,backgroundColor:'#fff',boxShadow:'5px 10px #888888'}}>   
                        ...
                        {/* customer name */}
                        <TextInputs configs={Configs.CustomerName} defaultInput={this.state.customerName} ChangeInputTextarea={this.ChangeInputTextarea} InputTitle={sectionNames.customerName} inputSize="lg" />
                        ...
                        <Form.Row dir="rtl">
                            {/* year  */}
                            <SelectInput IsMandatory={Configs.Year.isMandatory} inputList={Years} InputTitle={sectionNames.projectYear} ChangeSelectInput={this.ChangeSelectedInputs} />
                            {/* semester */}
                            <SelectInput IsMandatory={Configs.Semester.isMandatory} inputList={['שנתי','א','ב','קיץ']} InputTitle={sectionNames.projectSemester} ChangeSelectInput={this.ChangeSelectedInputs} />
                            {/*project topic */}
