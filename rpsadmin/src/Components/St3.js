    ...
    GetData=()=>{
        ...
        .then(()=>{
            ...
            this.setState({
                ...
                projectFindings:(dataForGroup.projectFindings || dataForGroup.projectFindings)?(dataForGroup.projectFindings || dataForGroup.projectFindings):'',                ProjectConclusion:dataForGroup.ProjectConclusion?dataForGroup.ProjectConclusion:'',
