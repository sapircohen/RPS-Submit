            ...
            switch (validator.fieldType) {
                case "text":
                    if(validator.isLength && !validator.isMandatory){
                        if(projectData[validator.Name] && (projectData[validator.Name]!==''&&(projectData[validator.Name].length<validator.minimum || projectData[validator.Name].length>validator.maximum))){
                            validation= {
                                    alertShow:true,
                                    alertTitle:'שימו לב',
                        ...
                        if(projectData[validator.Name] && projectData[validator.Name]===''  && validator.isMandatory){
                            validation=  {
                                alertShow:true,alertTitle:'שימו לב',alertText:validator.alertText,alertIcon:'warning',
                                isPublish:false
                            } 
                ...
                case "arraytext":
                        if(validator.isLength && validator.isMandatory){
                            if (projectData[validator.LinkedArray]) {
                    ...
                    break;
                case "select":
                        if(projectData[validator.Name]&&(projectData[validator.Name]==='' || projectData[validator.Name]==='בחר') && validator.isMandatory){
                            validation=  {
                                alertShow:true,alertTitle:'שימו לב',alertText:validator.alertText,alertIcon:'warning',
                                isPublish:false
                            } 
                    ...
                    break;
                case "arrayselect":
                        if(projectData[validator.Name]&&(projectData[validator.Name][validator.index]==='' || projectData[validator.Name][validator.index]==='בחר') && validator.isMandatory){
                            validation=  {
                                alertShow:true,alertTitle:'שימו לב',alertText:validator.alertText,alertIcon:'warning',
                                isPublish:false
                            } 
